...
router.post(
	...
	(req, res) => {
		...
		if (req.body.youtube)
			profileFields.social.youtube = normalizeUrl(
				req.body.youtube,
				normalizeUrlOptions
			);
		if (req.body.twitter)
			profileFields.social.twitter = normalizeUrl(
				req.body.twitter,
				normalizeUrlOptions
			);
		if (req.body.facebook)
			profileFields.social.facebook = normalizeUrl(
				req.body.facebook,
				normalizeUrlOptions
			);
		if (req.body.linkedin)
			profileFields.social.linkedin = normalizeUrl(
				req.body.linkedin,
				normalizeUrlOptions
			);
		if (req.body.instagram)
			profileFields.social.instagram = normalizeUrl(
				req.body.instagram,
				normalizeUrlOptions
			);
		//#endregion
...
router.get(
	...
	async (req, res) => {
		try {
			...
			/* filtering owned reops doesnt work since we're 
				getting a specific number of repos per page 
		*/
